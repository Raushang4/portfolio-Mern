        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-x-40">
          ...
          >
            ...
            <div className="flex items-center gap-7 text-4xl mt-5">
              <Link
                to="https://www.linkedin.com/in/raushang4"
                className="text-[#48a3ff]"
              >
                <FaLinkedin></FaLinkedin>
              </Link>
              <Link
                to="https://github.com/raushang4"
                className="text-[#43BD55]"
              >
                <FaGithub></FaGithub>
              </Link>
              <Link
                to="https://www.instagram.com/raushang_4"
                className="text-[#D61AA8]"
              >
                <FaInstagram></FaInstagram>
              </Link>
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=raushang4@gmail.com"
                target="blank"
